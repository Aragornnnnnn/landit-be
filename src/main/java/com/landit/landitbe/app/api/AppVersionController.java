...
import com.landit.landitbe.app.application.AppVersionQueryService;
...
public class AppVersionController {
    ...
    public ApiResponse<AppVersionCheckResponse> check(
            @Parameter(description = "앱 플랫폼", example = "IOS", required = true)
            @RequestParam AppPlatform platform,
            @Parameter(description = "현재 앱 빌드 번호", example = "18", required = true)
