...
public record SessionMessageSubmitResponse(
        ...
        Long sessionId,
        @Schema(description = "제출된 사용자 메시지")
        SubmittedMessageResponse submittedMessage,
        @Schema(description = "다음 AI 메시지")
    ...
    public record SubmittedMessageResponse(
            ...
            int turnNumber,
            @Schema(description = "세션 히스토리 안 메시지 순서")
            int messageSequence,
    ...
    public record NextMessageResponse(
            ...
            String content,
            @Schema(description = "기준 locale 번역")
    ...
    public record SessionProgressResponse(
            @Schema(description = "현재 턴 번호")
            int currentTurnNumber,
            @Schema(description = "현재 턴의 메시지 순서")
            int currentMessageSequenceNumber,
            @Schema(description = "고정 질문 개수")
