...
class SubmittedMessageRecorder {
    ...
    SubmittedMessageContext record(
        ...
        SessionHistoryMessage submittedMessage = saveUserMessage(
                sessionHistory,
                previousMessages,
                submittedTurnNumber,
                content,
        ...
        List<AiConversationHistoryMessage> conversationHistory = toConversationHistory(
                previousMessages,
                submittedMessage
        );
    ...
    void remove(SubmittedMessageContext submittedContext) {
        sessionHistoryMessageRepository.findById(submittedContext.submittedMessageId())
    ...
    private SessionHistoryMessage saveUserMessage(
        ...
        SessionHistoryMessage submittedMessage = sessionHistoryMessageRepository.save(
    ...
    private List<AiConversationHistoryMessage> toConversationHistory(
        ...
        return messages.stream()
                .map(this::toConversationHistoryMessage)
                .toList();
    }
    ...
    private record SessionHistoryLookup(
            SessionHistory sessionHistory,
            boolean created
    ) {
    }
