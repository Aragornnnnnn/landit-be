...
class SessionFeedbackRecorder {
    ...
    Long record(
        ...
        SessionHistorySummaryFeedback existing = sessionHistorySummaryFeedbackRepository
    ...
    private void saveMessageFeedbacks(
        ...
        for (int index = 0; index < context.userMessages().size(); index++) {
            ...
            sessionHistoryMessageFeedbackRepository.save(SessionHistoryMessageFeedback.completed(
                    summaryFeedbackId,
    ...
    private void completeSessionHistory(
        ...
        SessionHistory sessionHistory = sessionHistoryRepository.findById(context.sessionHistoryId())
                .orElseThrow(() -> new ApiException(ErrorCode.INTERNAL_SERVER_ERROR));
        int userMessageCount = Math.toIntExact(sessionHistoryMessageRepository
                .countBySessionHistoryIdAndRole(sessionHistory.getId(), ConversationSpeaker.USER));
