...
import com.landit.landitbe.feature.session.api.dto.SessionStartResponse.CurrentMessageResponse;
import com.landit.landitbe.feature.session.api.dto.SessionStartResponse.SessionProgressResponse;
...
import com.landit.landitbe.feature.session.infrastructure.ScenarioSessionLockRow;
import com.landit.landitbe.feature.session.infrastructure.ScenarioSessionRepository;
import com.landit.landitbe.feature.session.infrastructure.ScenarioSessionStartQueryRepository;
import com.landit.landitbe.feature.session.infrastructure.ScenarioSessionStartRow;
...
public class ScenarioSessionStartUseCase {
  ...
  private void assertPreviousScenarioCleared(long userId, ScenarioSessionStartRow startRow) {
    Optional<ScenarioSessionLockRow> previousScenario =
  ...
  private void ensureProgress(
      UserProfile userProfile, ScenarioSessionStartRow startRow, LocalDateTime startedAt) {
