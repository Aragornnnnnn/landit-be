...
package com.landit.landitbe.feature.session.scenario.repository;
...
public interface ScenarioSessionMessageQueryRepository
  ...
  @Query(
      """
            SELECT new com.landit.landitbe.feature.session.scenario.repository.projection.ScenarioSessionMessageContextProjection(
                scenario.id,
