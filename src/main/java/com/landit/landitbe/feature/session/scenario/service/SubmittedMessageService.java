...
class SubmittedMessageService {
  ...
  com.landit.landitbe.feature.session.scenario.dto.SessionMessageSubmitResponse replay(
      long userId,
      long sessionId,
      String content,
      SessionMessageInputType inputType,
    ...
    return stored.getScenarioResponsePayload() == null
        ...
        : mapper.readValue(
            ...
            com.landit.landitbe.feature.session.scenario.dto.SessionMessageSubmitResponse.class);
  }
