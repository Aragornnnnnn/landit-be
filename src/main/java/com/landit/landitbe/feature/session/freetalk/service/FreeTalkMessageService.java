...
import com.landit.landitbe.feature.session.freetalk.client.ai.AiFreeTalkClosingReason;
  ...
  public FreeTalkMessageSubmitResponse submit(
    ...
    try {
      ...
      if (response.turnStatus()
          != com.landit.landitbe.feature.session.freetalk.domain.FreeTalkTurnStatus
