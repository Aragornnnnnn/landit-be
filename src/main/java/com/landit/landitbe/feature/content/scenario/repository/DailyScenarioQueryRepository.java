...
import com.landit.landitbe.feature.content.scenario.repository.projection.DailyScenarioProjection;
...
public interface DailyScenarioQueryRepository extends JpaRepository<Scenario, Long> {
  ...
  @Query(
      """
            SELECT new com.landit.landitbe.feature.content.scenario.repository.projection.DailyScenarioProjection(
                s.id,
                s.characterId,
                slv.title,
                slv.briefing,
