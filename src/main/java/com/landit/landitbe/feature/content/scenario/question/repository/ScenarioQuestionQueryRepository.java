...
package com.landit.landitbe.feature.content.scenario.question.repository;

import com.landit.landitbe.feature.content.domain.ContentLearningLevel;
import com.landit.landitbe.feature.content.scenario.question.domain.ScenarioQuestion;
...
public interface ScenarioQuestionQueryRepository extends JpaRepository<ScenarioQuestion, Long> {
  ...
  @Query(
      """
            SELECT new com.landit.landitbe.feature.content.scenario.question.repository.projection.ScenarioQuestionProjection(
                scenarioQuestion.id,
