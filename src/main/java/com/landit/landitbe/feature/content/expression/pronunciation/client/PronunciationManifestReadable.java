...
package com.landit.landitbe.feature.content.expression.pronunciation.client;
...
public interface PronunciationManifestReadable {
   ...
   *
   * @param manifestKey 매니페스트 키 (예:
   *     content/expression-pronunciation-audio/manifests/2026-08-26.json)
