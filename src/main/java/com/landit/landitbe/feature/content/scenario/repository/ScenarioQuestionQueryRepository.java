...
import com.landit.landitbe.feature.content.scenario.domain.ScenarioQuestion;
...
public interface ScenarioQuestionQueryRepository extends JpaRepository<ScenarioQuestion, Long> {
  ...
  @Query(
      """
            SELECT new com.landit.landitbe.feature.content.scenario.repository.projection.ScenarioQuestionProjection(
                scenarioQuestion.id,
