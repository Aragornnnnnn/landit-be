...
package com.landit.landitbe.feature.content.expression.pronunciation.exception;
 ...
 *
 * <p>예시 — 대표 예문이 "I don't like it"이면 BE-> AI 요청은 항상 4단어다: [1: I] [2: don't] [3: like] [4: it]. 그런데
 * AI가 "I like it" 3단어짜리 답안지를 돌려주거나, order를 [1, 1, 2, 3]처럼 중복해 돌려주면 그대로 병합할 수 없어 이 예외로 거부한다.
 *
