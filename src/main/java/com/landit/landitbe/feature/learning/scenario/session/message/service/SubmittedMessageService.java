...
class SubmittedMessageService {
  ...
  com.landit.landitbe.feature.learning.scenario.session.message.dto.SessionMessageSubmitResponse
      replay(
          long userId,
          long sessionId,
          String content,
    ...
    return stored.getScenarioResponsePayload() == null
        ...
        : mapper.readValue(
            ...
            com.landit.landitbe.feature.learning.scenario.session.message.dto
                .SessionMessageSubmitResponse.class);
  }
