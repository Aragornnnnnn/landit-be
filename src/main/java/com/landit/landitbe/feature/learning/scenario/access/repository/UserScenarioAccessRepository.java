...
package com.landit.landitbe.feature.learning.scenario.access.repository;
      ...
      """
            ...
            WHERE learningSession.userProfileId = :userProfileId
              ...
              AND learningSession.status IN (
                  com.landit.landitbe.feature.learning.conversation.domain.LearningSessionStatus.IN_PROGRESS,
                  com.landit.landitbe.feature.learning.conversation.domain.LearningSessionStatus.INTERRUPTED
              )
