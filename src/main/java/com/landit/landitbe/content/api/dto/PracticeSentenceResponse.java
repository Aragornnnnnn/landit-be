...
public record PracticeSentenceResponse(
        ...
        @Schema(description = "예문 해석", example = "그녀 목소리는 들을 때마다 소름 돋아.")
        String sentenceTranslation,

        @Schema(description = "예문을 유도하는 연습 질문", example = "What do you think of her singing?")
        String practiceQuestion,

        @Schema(description = "연습 질문의 해석", example = "걔 노래 어때?")
        String practiceQuestionTranslation,

        @Schema(description = "예문 이미지 URL. 없으면 null", example = "https://cdn.landit.com/writing/examples/001.png")
        String imageUrl
) {
}
