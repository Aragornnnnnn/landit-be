...
public record WritingSentenceResponse(
        @Schema(description = "작문용으로 선택된 예문 영어 텍스트(정답 비교용)", example = "The special effects blew my mind.")
        String writingSentenceText,

        @Schema(description = "선택된 예문의 해석", example = "특수효과가 끝내줬어.")
        String writingSentenceTranslation,

        @Schema(description = "선택된 예문의 연습 질문", example = "How was the musical?")
