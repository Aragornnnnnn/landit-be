...
- [ ] **Step 1: Service 경계 단위 테스트를 작성한다**
...
- [ ] **Step 2: Repository 직접 의존을 Service 호출로 교체한다**
...
- [ ] **Step 3: 기능 간 Repository 의존이 사라졌는지 검사한다**
